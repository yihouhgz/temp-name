import { defineComponent, createVNode, Fragment, watchEffect, onUnmounted, watch, toValue, onScopeDispose, onWatcherCleanup, computed, getCurrentInstance, mergeProps, ref, h, createTextVNode, reactive, onMounted, onBeforeUnmount, inject, provide, useAttrs, Teleport, effectScope, nextTick, cloneVNode, isVNode, createApp } from 'vue';
...
var Wave = defineComponent(function (props, _a) {
  var slots = _a.slots;
  if (props.disabled) return function () {
    var _a;
    return createVNode(Fragment, null, [(_a = slots.default) === null || _a === void 0 ? void 0 : _a.call(slots)]);
  };else {
    var showEffect_1 = function () {
      ...
      (_c = props.target) === null || _c === void 0 ? void 0 : _c.insertBefore(holder, (_d = props.target) === null || _d === void 0 ? void 0 : _d.firstChild);
    ...
    watchEffect(function () {
      if (props.target) props.target.addEventListener('click', handleClick_1, {
        capture: true
      });
    });
...
var hasPropsOrSlots = function (slotName, vm) {
  ...
  var slots = vm.slots,
    props = vm.props;
  return Boolean(props[slotName]) || isFunction(slots === null || slots === void 0 ? void 0 : slots[slotName]);
};
...
var renderElementForPropsOrSlot = function (slotName, vm) {
  ...
  var vSlots = (_a = slots === null || slots === void 0 ? void 0 : slots[sName]) === null || _a === void 0 ? void 0 : _a.call(slots);
  return vSlots;
};
...
var useEventListener = function (target, eventName, handler, options) {
  ...
  var cleaup = function () {
    var _a;
    stopWatch();
    (_a = toValue(target)) === null || _a === void 0 ? void 0 : _a.removeEventListener(eventName, handler, options);
  };
...
var consolaWapper = generateConsola();
  ...
  setup: function (props, ctx) {
    var spanClass = computed(function () {
      ...
      var spin = props.spin,
        size = props.size,
        type = props.type;
      return ["".concat(prefix, "-icon"), "".concat(prefix, "-icon-").concat(size), "".concat(prefix, "-icon-").concat(type), (_a = {}, _a["".concat(prefix, "-icon-spin")] = spin, _a)];
    });
    ...
    return function () {
      ...
      }, ctx.attrs), [renderElementForPropsOrSlot({
        propName: 'svg',
        slotName: 'default'
      }, vm)]);
    };
...
var nameToSplit = function (name) {
  ...
  for (var _i = 0, name_1 = name; _i < name_1.length; _i++) {
    var s = name_1[_i];
    if (s === s.toLocaleUpperCase() && s !== '-') str += '-' + s.toLocaleLowerCase();else str += s;
  }
  return str;
};
function warpperIcon(icon, name) {
  ...
  var InnerIcon = defineComponent({
    setup: function (props) {
      return function () {
        return createVNode(IconJsx, mergeProps({
          "svg": renderIcon,
          "type": name
        }, props), null);
      };
...
var Icon = defineComponent({
  ...
  setup: function (props, ctx) {
    ...
    var iconClass = computed(function () {
      var _a;
      return ["".concat(prefix, "-icon"), (_a = {}, _a["".concat(prefix, "-icon-").concat(props.size)] = props.size, _a["".concat(prefix, "-icon-disabled")] = props.disabled, _a)];
    });
...
var IconLoading = defineComponent(function (props) {
  ...
  return function () {
    return createVNode("svg", mergeProps({
      ...
      "aria-hidden": "true",
      "data-icon": "spin"
    }, props), [createVNode("defs", null, [createVNode("linearGradient", {
      "x1": "0%",
      "y1": "100%",
      "x2": "100%",
      "y2": "100%",
...
var Button = defineComponent({
  setup: function (props, ctx) {
    ...
    var iconRender = function () {
      if (props.loading) return createVNode(IconLoading$1, {
        "class": "".concat(prefix, "-button-loading-icon")
      }, null);else {
        return props.icon ? isFunction(props.icon) ? props.icon() : props.icon : ctx.slots.icon ? ctx.slots.icon() : createVNode(Fragment, null, null);
      }
    };
    var defaultTextRender = function () {
      var _a, _b;
      var vnode = (_b = (_a = ctx.slots).default) === null || _b === void 0 ? void 0 : _b.call(_a);
      if (props.autoInsertSpace && vnode && vnode[0] && isString(vnode[0].children) && vnode[0].children.length === 2) {
    ...
    var buttonClass = computed(function () {
      var _a;
      return ["".concat(prefix, "-button"), "".concat(prefix, "-button-").concat(props.type), "".concat(prefix, "-button-").concat(props.size), "".concat(prefix, "-button-").concat(props.theme), (_a = {}, _a["".concat(prefix, "-button-disabled")] = props.disabled, _a["".concat(prefix, "-button-").concat(props.type, "-disabled")] = props.disabled, _a["".concat(prefix, "-button-loading")] = props.loading && !props.disabled, _a["".concat(prefix, "-button-icon")] = ctx.slots.icon, _a["".concat(prefix, "-button-block")] = props.block, _a)];
    });
    ...
    return function () {
      ...
      if (iconOnlyClass) classNames.push("".concat(prefix, "-button-with-icon-only"));else if (!iconOnlyClass && hasPropsOrSlots('icon', vm)) {
...
var SyncButton = defineComponent({
  setup: function (props, ctx) {
    ...
    return function () {
      var _a, _b;
      return createVNode(Button, mergeProps(props, ctx.attrs, {
        "loading": loading.value,
        "onClick": handleClick
      }), {
        default: () => [(_b = (_a = ctx.slots).default) === null || _b === void 0 ? void 0 : _b.call(_a)]
      });
    };
  },
  inheritAttrs: false,
    ...
    return function () {
      ...
      for (var _i = 0, buttons_1 = buttons; _i < buttons_1.length; _i++) {
        ...
        if (index < buttons.length - 1) {
          var lineClass = [prefix + '-button-group-line', prefix + '-button-group-line-' + theme, prefix + '-button-group-line-' + type];
          template.push(createVNode("span", {
            "class": lineClass
          }, null));
        }
        index++;
...
var Input = defineComponent({
  setup: function (props, ctx) {
    ...
    var inputWrapperClass = computed(function () {
      var _a;
      return ["".concat(prefix, "-input"), "".concat(prefix, "-input-") + props.size, (_a = {}, _a["".concat(prefix, "-input-disabled")] = props.disabled, _a["".concat(prefix, "-input-clearable")] = props.showClear, _a["".concat(prefix, "-input-borderless")] = props.borderless, _a["".concat(prefix, "-input-").concat(props.validateStatus)] = props.validateStatus !== 'default', _a["".concat(prefix, "-input-focus")] = inputSelfData.focus, _a)];
    });
    var inputTargetClass = computed(function () {
      var _a;
      return ["".concat(prefix, "-input-target"), "".concat(prefix, "-input-target-") + props.size, (_a = {}, _a["".concat(prefix, "-input-target-disabled")] = props.disabled, _a["".concat(prefix, "-input-target-clearable")] = props.showClear, _a)];
    });
    ...
    var handleControlInputCursorForFocus = function () {
      ...
      requestAnimationFrame(function () {
        ...
        if (len) (_b = inputRef.value) === null || _b === void 0 ? void 0 : _b.setSelectionRange(len, len);
      });
    };
    ...
    onMounted(function () {
      var _a, _b;
      if (props.showClear) {
        (_a = inputWrapperRef.value) === null || _a === void 0 ? void 0 : _a.addEventListener('mousemove', handleMoveEnter);
        (_b = inputWrapperRef.value) === null || _b === void 0 ? void 0 : _b.addEventListener('mouseleave', handleMoveLeave);
      }
    });
    onBeforeUnmount(function () {
      var _a, _b;
      (_a = inputWrapperRef.value) === null || _a === void 0 ? void 0 : _a.removeEventListener('mousemove', handleMoveEnter);
      (_b = inputWrapperRef.value) === null || _b === void 0 ? void 0 : _b.removeEventListener('mouseleave', handleMoveLeave);
    });
    ...
    if (props.modelValue !== undefined && props.value !== undefined) {
      consolaWapper.warn('Input components modelValue and value cannot be passed in simultaneously.');
    }
    ...
    return function () {
      ...
      }, ctx.attrs), null), showClearIconWapper.value && createVNode("div", {
        "class": "".concat(prefix, "-input-clearable-icon")
      }, [createVNode(Icon, {
        "disabled": props.disabled,
        "name": "IconClear",
        "onClick": handleClearInput
      }, null)]), props.type === 'password' && createVNode("div", {
        "class": "".concat(prefix, "-input-password-icon")
      }, [inputSelfData.showPassword ? createVNode(IconEyeOpened$1, {
        "disabled": props.disabled,
        "onClick": triggerPasswordStatus
      }, null) : createVNode(IconEyeClosedSolid$1, {
        "disabled": props.disabled,
        "onClick": triggerPasswordStatus
      }, null)])]);
    };
...
var getGutter = function (gutter, scope) {
  ...
  if (isNumber(gutter)) {
    return _a = {}, _a["".concat(attrName, "Left")] = -gutter / 2 * trend + 'px', _a["".concat(attrName, "Right")] = -gutter / 2 * trend + 'px', _a;
  } else if (isArray(gutter)) {
    var gutterX = gutter[0],
      gutterY = gutter[1];
    if (!isNumber(gutterX)) {
      consolaWapper.error('gutterX must be a number');
    }
    if (!isNumber(gutterY)) {
      consolaWapper.error('gutterY must be a number');
    }
    return _b = {}, _b[attrName] = "".concat(-gutterY / 2 * trend, "px ").concat(-gutterX / 2 * trend, "px"), _b;
  }
  //对象响应式处理 todo
  return {};
};
...
var Row = defineComponent(function (props, ctx) {
  ...
  var rowClass = computed(function () {
    var _a;
    return [props.type === 'flex' ? "".concat(prefix, "-row-").concat(props.type) : "".concat(prefix, "-row"), (_a = {}, _a["".concat(prefix, "-row-flex-").concat(props.justify)] = props.justify, _a["".concat(prefix, "-row-flex-").concat(props.align)] = props.align, _a)];
  });
  return function () {
    var _a, _b;
    return createVNode("div", {
...
var Col = defineComponent(function (props, ctx) {
  var rowScope = useRowScope();
  if (!rowScope) consolaWapper.warn('Col must be placed as a child of Row');
  var colClass = computed(function () {
    var _a;
    var span = props.span;
    return ["".concat(prefix, "-col"), "".concat(prefix, "-col-").concat(span), (_a = {}, _a["".concat(prefix, "-col-offset-").concat(props.offset)] = props.offset, _a)];
  });
  var colStyle = computed(function () {
    if (rowScope) return getGutter(rowScope.gutter, true);else return {};
  });
  return function () {
    var _a, _b;
    ...
    }, ctx.attrs), [(_b = (_a = ctx.slots).default) === null || _b === void 0 ? void 0 : _b.call(_a)]);
  };
}, {
  name: prefix + '-col',
  props: props$1
...
var Flex = defineComponent(function (props, ctx) {
  return function () {
    var _a, _b;
    return createVNode(Row, mergeProps(props, ctx.attrs, {
      "type": "flex"
    }), {
      default: () => [(_b = (_a = ctx.slots).default) === null || _b === void 0 ? void 0 : _b.call(_a)]
    });
...
var popoverProps = {
  ...
  position: {
    values: ['top', 'topLeft', 'topRight', 'left', 'leftTop', 'leftBottom', 'right', 'rightTop', 'rightBottom', 'bottom', 'bottomLeft', 'bottomRight'],
    default: 'top',
    required: false
  },
  /**
...
var positionValues = ['top', 'topLeft', 'topRight', 'left', 'leftTop', 'leftBottom', 'right', 'rightTop', 'rightBottom', 'bottom', 'bottomLeft', 'bottomRight'];
var tooltioProps = {
  /**
...
var Portal = defineComponent(function (props, ctx) {
  var innerRef = ref();
...
var getReverse = function (viewOverFlow, containerOverFlow, shouldReverseView, shouldReverseContainer) {
  /**
...
var adjustPosIfNeed = function (position, style, triggerRect, wrapperRect, containerRect, utils) {
  ...
  if (wrapperRect.width > 0 && wrapperRect.height > 0) {
    ...
    var shouldViewReverseTop = clientTop - marginTop < wrapperRect.height + spacing && restClientBottom - marginBottom > wrapperRect.height + spacing;
    var shouldViewReverseLeft = clientLeft - marginLeft < wrapperRect.width + spacing && restClientRight - marginRight > wrapperRect.width + spacing;
    var shouldViewReverseBottom = restClientBottom - marginBottom < wrapperRect.height + spacing && clientTop - marginTop > wrapperRect.height + spacing;
    var shouldViewReverseRight = restClientRight - marginRight < wrapperRect.width + spacing && clientLeft - marginLeft > wrapperRect.width + spacing;
    ...
    //   clientBottom - marginTop < wrapperRect.height + spacing &&
    //   restClientTop - marginBottom > wrapperRect.height + spacing
    var shouldViewReverseTopSide = restClientTop < wrapperRect.height + ano_spacing && clientBottom > wrapperRect.height + ano_spacing;
    var shouldViewReverseBottomSide = clientBottom < wrapperRect.height + ano_spacing && restClientTop > wrapperRect.height + ano_spacing;
    var shouldViewReverseLeftSide = restClientLeft < wrapperRect.width + ano_spacing && clientRight > wrapperRect.width + ano_spacing;
    var shouldViewReverseRightSide = clientRight < wrapperRect.width + ano_spacing && restClientLeft > wrapperRect.width + ano_spacing;
    var shouldReverseTopOver = restClientTop < wrapperRect.height + spacing && clientBottom > wrapperRect.height + spacing;
    var shouldReverseBottomOver = clientBottom < wrapperRect.height + spacing && restClientTop > wrapperRect.height + spacing;
    var shouldReverseLeftOver = restClientLeft < wrapperRect.width && clientRight > wrapperRect.width;
    var shouldReverseRightOver = clientRight < wrapperRect.width && restClientLeft > wrapperRect.width;
    // 基于容器的微调判断
    ...
    var shouldContainerReverseTop = isReverse(clientTopInContainer - marginTop, restClientBottomInContainer - marginBottom, wrapperRect.height + spacing);
    var shouldContainerReverseLeft = isReverse(clientLeftInContainer - marginLeft, restClientRightInContainer - marginRight, wrapperRect.width + spacing);
    var shouldContainerReverseBottom = isReverse(restClientBottomInContainer - marginBottom, clientTopInContainer - marginTop, wrapperRect.height + spacing);
    var shouldContainerReverseRight = isReverse(restClientRightInContainer - marginRight, clientLeftInContainer - marginLeft, wrapperRect.width + spacing);
    ...
    //   wrapperRect.height + spacing
    // )
    var shouldContainerReverseTopSide = isReverse(restClientTopInContainer, clientBottomInContainer, wrapperRect.height + ano_spacing);
    var shouldContainerReverseBottomSide = isReverse(clientBottomInContainer, restClientTopInContainer, wrapperRect.height + ano_spacing);
    var shouldContainerReverseLeftSide = isReverse(restClientLeftInContainer, clientRightInContainer, wrapperRect.width + ano_spacing);
    var shouldContainerReverseRightSide = isReverse(clientRightInContainer, restClientLeftInContainer, wrapperRect.width + ano_spacing);
    ...
    var isViewYOverFlow = isOverFlow(clientTop - marginTop, restClientBottom - marginBottom, wrapperRect.height + spacing);
    var isViewXOverFlow = isOverFlow(clientLeft - marginLeft, restClientRight - marginRight, wrapperRect.width + spacing);
    var isViewYOverFlowSide = isOverFlow(clientBottom - marginTop, restClientTop - marginBottom, wrapperRect.height + spacing);
    var isViewXOverFlowSide = isOverFlow(clientRight - marginLeft, restClientLeft - marginRight, wrapperRect.width + spacing);
    var isViewYOverFlowSideHalf = isHalfOverFlow(clientBottom - halfHeight, restClientTop - halfHeight, (wrapperRect.height + ano_spacing) / 2);
    var isViewXOverFlowSideHalf = isHalfOverFlow(clientRight - halfWidth, restClientLeft - halfWidth, (wrapperRect.width + ano_spacing) / 2);
    var isViewYEnoughSideHalf = isHalfAllEnough(clientBottom - halfHeight, restClientTop - halfHeight, (wrapperRect.height + ano_spacing) / 2);
    var isViewXEnoughSideHalf = isHalfAllEnough(clientRight - halfWidth, restClientLeft - halfWidth, (wrapperRect.width + ano_spacing) / 2);
    // 容器, 原空间与反向空间是否都不足判断
    // container, whether the original space and the reverse space are insufficient to judge
    var isContainerYOverFlow = isOverFlow(clientTopInContainer - marginTop, restClientBottomInContainer - marginBottom, wrapperRect.height + spacing);
    var isContainerXOverFlow = isOverFlow(clientLeftInContainer - marginLeft, restClientRightInContainer - marginRight, wrapperRect.width + spacing);
    var isContainerYOverFlowSide = isOverFlow(clientBottomInContainer - marginTop, restClientTopInContainer - marginBottom, wrapperRect.height + spacing);
    var isContainerXOverFlowSide = isOverFlow(clientRightInContainer - marginLeft, restClientLeftInContainer - marginRight, wrapperRect.width + spacing);
    var isContainerYOverFlowSideHalf = isHalfOverFlow(clientBottomInContainer - halfHeight, restClientTopInContainer - halfHeight, (wrapperRect.height + ano_spacing) / 2);
    var isContainerXOverFlowSideHalf = isHalfOverFlow(clientRightInContainer - halfWidth, restClientLeftInContainer - halfWidth, (wrapperRect.width + ano_spacing) / 2);
    var isContainerYEnoughSideHalf = isHalfAllEnough(clientBottomInContainer - halfHeight, restClientTopInContainer - halfHeight, (wrapperRect.height + ano_spacing) / 2);
    var isContainerXEnoughSideHalf = isHalfAllEnough(clientRightInContainer - halfWidth, restClientLeftInContainer - halfWidth, (wrapperRect.width + ano_spacing) / 2);
    ...
    var shouldReverseTop = getReverse(isViewYOverFlow, isContainerYOverFlow, shouldViewReverseTop, shouldContainerReverseTop);
    var shouldReverseLeft = getReverse(isViewXOverFlow, isContainerXOverFlow, shouldViewReverseLeft, shouldContainerReverseLeft);
    var shouldReverseBottom = getReverse(isViewYOverFlow, isContainerYOverFlow, shouldViewReverseBottom, shouldContainerReverseBottom);
    var shouldReverseRight = getReverse(isViewXOverFlow, isContainerXOverFlow, shouldViewReverseRight, shouldContainerReverseRight);
    ...
    var shouldReverseTopSide = getReverse(isViewYOverFlowSide, isContainerYOverFlowSide, shouldViewReverseTopSide, shouldContainerReverseTopSide);
    var shouldReverseBottomSide = getReverse(isViewYOverFlowSide, isContainerYOverFlowSide, shouldViewReverseBottomSide, shouldContainerReverseBottomSide);
    var shouldReverseLeftSide = getReverse(isViewXOverFlowSide, isContainerXOverFlowSide, shouldViewReverseLeftSide, shouldContainerReverseLeftSide);
    var shouldReverseRightSide = getReverse(isViewXOverFlowSide, isContainerXOverFlowSide, shouldViewReverseRightSide, shouldContainerReverseRightSide);
  ...
  if (position && triggerRect && translateX != null && translateY != null) {
    if (utils.getProp('transformFromCenter')) {
      ...
      if (['topRight', 'bottomRight'].includes(position)) {
        return "calc(100% - ".concat(_roundPixel(triggerRect.width / 2), "px) ").concat(-translateY * 100, "%");
      }
      ...
      if (['leftBottom', 'rightBottom'].includes(position)) {
        return "".concat(-translateX * 100, "% calc(100% - ").concat(_roundPixel(triggerRect.height / 2), "px)");
      }
    }
...
var calcPosStyle = function (props) {
  ...
  var spacing = props.spacing,
    ...
    utils = props.utils;
  var innerWidth = window.innerWidth;
  var triggerRect = (isEmpty(props.triggerRect) ? props.triggerRect : utils.getTriggerBounding()) || __assign({}, defaultRect);
  var containerRect = (isEmpty(props.containerRect) ? props.containerRect : utils.getPopupContainerRect()) || __assign({}, defaultRect);
  var wrapperRect = (isEmpty(props.wrapperRect) ? props.wrapperRect : utils.getWrapperBounding()) || __assign({}, defaultRect);
  ...
  var scaled = Math.abs((wrapperRect === null || wrapperRect === void 0 ? void 0 : wrapperRect.width) - ((_a = utils.getContainer()) === null || _a === void 0 ? void 0 : _a.clientWidth)) > 1;
  if (scaled) {
  ...
  if (utils.getProp('showArrow') && !arrowPointAtCenter && triggerHeight <= (verticalArrowHeight / 2 + arrowOffsetY) * 2) {
...
var calcPosition = function (utils, triggerRect, wrapperRect, containerRect, shouldUpdatePos) {
  ...
  triggerRect = (isEmpty(triggerRect) ? utils.getTriggerBounding() : triggerRect) || __assign({}, defaultRect);
  containerRect = (isEmpty(containerRect) ? utils.getPopupContainerRect() : containerRect) || __assign({}, defaultRect);
  wrapperRect = (isEmpty(wrapperRect) ? utils.getWrapperBounding() : wrapperRect) || __assign({}, defaultRect);
  ...
  if (shouldUpdatePos) {
    ...
    utils.setPosition(__assign(__assign({}, style), {
      position: position
    }));
  }
  return style;
...
var CSSAnimation = defineComponent({
  ...
  setup: function (props, _a) {
    ...
    watch(function () {
      ...
      // 如果没有动画，立即结束
      if (!props.motion) {
        (_b = props.onAnimationEnd) === null || _b === void 0 ? void 0 : _b.call(props, isAnimating.value);
        isAnimating.value = false;
      }
    });
    // 组件挂载后处理
...
var Tooltip = defineComponent({
  setup: function (props, ctx) {
    ...
    var wrapperClass = computed(function () {
      return [props.wrapper ? props.wrapper : "".concat(prefix, "-tooltip-wrapper"), "".concat(prefix, "-tooltip-") + props.position];
    });
    var arrowClass = computed(function () {
      var _a;
      var _position = (_a = innerStyle.value) === null || _a === void 0 ? void 0 : _a._position;
      return ["".concat(prefix, "-tooltip-arrow"), "".concat(prefix, "-tooltip-") + (_position || props.position) + '-arrow'];
    });
    var show = ref(false);
        ...
        useEventListener(target, eventMap.leave, function () {
          if (eventMap.leave === 'mouseleave') {
            scope_1.run(function () {
              ...
              // 鼠标移出
              useEventListener(innerRef.value, 'mouseenter', function () {
                return hoverInInner = true;
              }, {
                once: true
              });
              useEventListener(innerRef.value, 'mouseleave', function () {
                hoverInInner = false;
                triggerLeave();
              }, {
                once: true
    ...
    var _defaultRender = function () {
      var _a, _b;
      var children = (_b = (_a = ctx.slots).default) === null || _b === void 0 ? void 0 : _b.call(_a);
      if (children && children.length) {
        var newChildren_1 = [];
        children.forEach(function (child) {
          // if child solt is Component
          console.log(child, 'kk');
          newChildren_1.push(isComponentByVNode(child) ? cloneVNode(child, {
            ref: slotRef
          }) : child);
        });
    ...
    return function () {
      var _a, _b;
      return createVNode(Fragment, null, [showTooltip.value && createVNode(Portal, {
        ...
        default: () => [createVNode(CSSAnimation, {
          "fillMode": "forwards",
          "motion": props.motion,
          "animationState": animationOptions.transitionState,
          "startClassName": animationOptions.transitionState === 'enter' ? "".concat(prefix, "-tooltip-animation-show") : "".concat(prefix, "-tooltip-animation-hide"),
          "onAnimationStart": handleAnimationStart,
          "onAnimationEnd": handleAnimationEnd
        }, {
          default: function (_a) {
            ...
            return createVNode("div", mergeProps({
              ...
              "class": __spreadArray(__spreadArray([], wrapperClass.value, true), [animationClassName], false),
              "ref": innerRef
            }, animationEventsNeedBind, allAttrs), [createVNode("div", {
              "class": "".concat(prefix, "-tooltip-content")
            }, [createVNode(ContentWrapper, null, null)]), props.showArrow && createVNode("svg", {
...
var Popover = defineComponent({
  setup: function (props, ctx) {
    ...
    var wrapperClassNames = computed(function () {
      return ["".concat(prefix, "-popover-wrapper"), props.showArrow ? "".concat(prefix, "-popover-with-arrow") : ''].filter(Boolean).join(' ');
    });
    return function () {
      var _a, _b;
      return createVNode(Tooltip, mergeProps(props, {
...
var SelectOption = defineComponent({
  setup: function (props, ctx) {
    ...
    var optionClassName = computed(function () {
      var _a;
      return [prefix + '-select-option', (_a = {}, _a[prefix + '-select-option-selected'] = props._selected, _a[prefix + '-select-option-focused'] = props._focused, _a[prefix + '-select-option-disabled'] = props.disabled, _a)];
    });
    onMounted(function () {
    ...
    return function () {
      ...
      }, [props._selected && createVNode(IconTick$1, null, null)]), createVNode("div", {
        "class": prefix + '-select-option-text'
      }, [props.label ? props.label : (_b = (_a = ctx.slots).default) === null || _b === void 0 ? void 0 : _b.call(_a)])]);
    };
  },
...
var SelectOptionGroup = defineComponent({
  setup: function (props, ctx) {
    return function () {
      ...
      }, [props.label]), (_b = (_a = ctx.slots).default) === null || _b === void 0 ? void 0 : _b.call(_a)]);
    };
  },
  props: {
    label: {
...
var Avatar$1 = defineComponent({
  setup: function (props, ctx) {
    ...
    var baseClass = computed(function () {
      var _a, _b;
      return ["".concat(prefix, "-avatar"), "".concat(prefix, "-avatar-").concat(props.shape), (_a = {}, _a["".concat(prefix, "-avatar-").concat(props.size)] = isString(props.size), _a), props.src ? "".concat(prefix, "-avatar-img") : "".concat(prefix, "-avatar-").concat(props.color), (_b = {}, _b["".concat(prefix, "-avatar-animated")] = props.contentMotion, _b)];
    });
    var computedScale = computed(function () {
      var _a;
      var gap = props.gap;
      var containerEl = container.value;
      var stringEl = (_a = container.value) === null || _a === void 0 ? void 0 : _a.firstElementChild;
      if (stringEl && containerEl && gap) {
        var _b = [(containerEl === null || containerEl === void 0 ? void 0 : containerEl.offsetWidth) || 0, (stringEl === null || stringEl === void 0 ? void 0 : stringEl.offsetWidth) || 0],
          nodeWidth = _b[0],
          stringNodeWidth = _b[1];
        if (nodeWidth !== 0 && stringNodeWidth !== 0 && gap * 2 < nodeWidth) {
          var scale = nodeWidth - gap * 2 > stringNodeWidth ? 1 : (nodeWidth - gap * 2) / stringNodeWidth;
          return {
    ...
    return function () {
      ...
      var content = createVNode(Fragment, null, [createVNode("span", {
        "class": "".concat(prefix, "-avatar-content"),
        "style": computedScale.value
      }, [createVNode("span", {
        "class": "".concat(prefix, "-avatar-label")
      }, [(_b = (_a = ctx.slots).default) === null || _b === void 0 ? void 0 : _b.call(_a)])]), showHoverMaskComputed.value && createVNode("span", {
        "class": "".concat(prefix, "-avatar-hover")
      }, [hoverMaskRender()])]);
      if (props.src) {
        content = createVNode(Fragment, null, [createVNode("img", mergeProps({
          "class": "".concat(prefix, "-avatar-img"),
          "src": props.src,
          "alt": props.alt
        }, props.imgAttr, {
          "style": computedScale.value
        }), null), showHoverMaskComputed.value && createVNode("span", {
          "class": "".concat(prefix, "-avatar-hover")
        }, [hoverMaskRender()])]);
      }
      ...
      var avatarBase = createVNode("span", mergeProps({
        "class": baseClass.value,
        "style": baseStyle
      }, baseAttrs, {
        "ref": container
      }, handlerAttrs), [content]);
      if (showWrapper) {
        var style = {
          position: 'relative',
          margin: 'inherit'
        ...
        var getBorderClass = function () {
          return ["".concat(prefix, "-avatar-border"), isString(props.size) ? "".concat(prefix, "-avatar-border-").concat(props.size) : '', "".concat(prefix, "-avatar-").concat(props.shape)];
        };
        var mergnStyle = {
          style: borderColor ? {
        ...
        var renderTopSlot = function () {
          ...
          if (topSlot === null || topSlot === void 0 ? void 0 : topSlot.render) return renderVnode(topSlot.render);
          var optionStyle = {};
          if (topSlot.textColor) optionStyle.color = topSlot.textColor;
          var slotWrapperClass = ["".concat(prefix, "-avatar-top-slot"), (_a = {}, _a[topSlot.className] = Boolean(topSlot.className), _a), (_b = {}, _b["".concat(prefix, "-avatar-animated")] = props.contentMotion, _b)];
          var slotWrapperStyle = topSlot.style;
          var bgClass = ["".concat(prefix, "-avatar-top-slot-bg"), "".concat(prefix, "-avatar-top-slot-bg-").concat(props.size)];
          var bgSvgClass = ["".concat(prefix, "-avatar-top-slot-bg-svg"), "".concat(prefix, "-avatar-top-slot-bg-svg-").concat(props.size)];
          var gradientStart = (_c = topSlot.gradientStart) !== null && _c !== void 0 ? _c : "var(--".concat(prefix, "-color-primary)");
          var gradientEnd = (_d = topSlot.gradientEnd) !== null && _d !== void 0 ? _d : "var(--".concat(prefix, "-color-primary)");
          var exclusion = ['extra-extra-small', 'extra-small'];
          var contentClass = ["".concat(prefix, "-avatar-top-slot-content"), "".concat(prefix, "-avatar-top-slot-content-").concat(props.size)];
          return createVNode("div", {
            "class": slotWrapperClass,
            "style": slotWrapperStyle
          }, [!exclusion.includes(props.size) && createVNode("div", {
            "class": bgClass
          }, [createVNode("div", {
            "class": bgSvgClass
          }, [createVNode(TopSlotIcon, {
        ...
        var renderBottomSlot = function () {
          ...
          if (bottomSlot === null || bottomSlot === void 0 ? void 0 : bottomSlot.render) return renderVnode(bottomSlot.render);
          var optionStyle = {};
          ...
          var optionClass = ["".concat(prefix, "-avatar-bottom-slot-shape-").concat((_b = bottomSlot.shape) !== null && _b !== void 0 ? _b : props.shape), "".concat(prefix, "-avatar-bottom-slot-shape-circle-").concat(props.size)];
          var slotWrapperClass = ["".concat(prefix, "-avatar-bottom-slot"), (_a = {}, _a[bottomSlot.className] = Boolean(bottomSlot.className), _a)];
        ...
        return createVNode("div", mergeProps({
          ...
          "style": style
        }, [avatarBase, props.border && createVNode("span", mergnStyle, null), props.border && Boolean(props.border.motion) && createVNode("span", mergeProps(mergnStyle, {
          "class": "".concat(prefix, "-avatar-border-animated")
        }), null)]), showSopSlot && renderTopSlot(), showBottomSlot && renderBottomSlot()]);
      }
      return avatarBase;
    };
  },
...
var AvatarGroup = defineComponent({
  setup: function (props, ctx) {
    ...
    var defaultRenderSlot = function () {
      var _a, _b, _c;
      var vnodes = ((_b = (_a = ctx.slots).default) === null || _b === void 0 ? void 0 : _b.call(_a)) || [];
      ...
      var avatarNodes = visibleNodes === null || visibleNodes === void 0 ? void 0 : visibleNodes.map(function (item) {
        if (!isObject(item) || item.type.name !== childrenName) {
          ...
          return h(Avatar$1, __assign(__assign({}, item.props), {
            shape: props.shape,
            size: props.size,
            style: avatarStyle
      ...
      if (showWraning) consolaWapper.warn('AvatarGroup only accepts Avatar as children.');
      if (props.overlapFrom === 'end') {
        return (_c = __spreadArray([], avatarNodes, true)) === null || _c === void 0 ? void 0 : _c.reverse();
      }
      if ((vnodes === null || vnodes === void 0 ? void 0 : vnodes.length) > props.maxCount) {
        ...
        return __spreadArray(__spreadArray([], avatarNodes.slice(0, props.maxCount), true), [renderMoreSlot], false);
      }
      return avatarNodes;
    };
    var classNames = computed(function () {
      var _a;
      return [prefix + '-avatar-group', (_a = {}, _a[prefix + '-avatar-group-hover'] = showHover.value, _a)];
    });
    return function () {
      return createVNode("div", {
...
var Tag = defineComponent({
  setup: function (props, _a) {
    ...
    var classes = computed(function () {
      return ["".concat(prefix, "-tag"), props.color ? "".concat(prefix, "-tag-").concat(props.color, "-").concat(props.type) : '', "".concat(prefix, "-tag-").concat(props.size), "".concat(prefix, "-tag-").concat(props.shape), "".concat(prefix, "-tag-").concat(props.type), !props.visible ? "".concat(prefix, "-tag-visible") : ""];
    });
    // 关闭事件
    ...
    return function () {
      return createVNode("div", {
        "class": classes.value,
        "onClick": handleClick
      }, [renderElementForPropsOrSlot('prefixIcon', instance) || props.prefixIcon && (props.prefixIcon instanceof Function ? props.prefixIcon() : props.prefixIcon), props.avatarSrc && createVNode(Avatar, {
        "size": "extra-small",
        "shape": props.avatarShape,
        "src": props.avatarSrc
      }, null), slots.default ? slots.default() : 'Tag', renderElementForPropsOrSlot('suffixIcon', instance) || props.suffixIcon && (props.suffixIcon instanceof Function ? props.suffixIcon() : props.suffixIcon), props.closable && createVNode("div", {
...
var TagGroup = defineComponent({
  setup: function (props, _a) {
    ...
    // 计算类名
    var classes = computed(function () {
      return ["".concat(prefix, "-tag-group"), "".concat(prefix, "-tag-group-").concat(props.size), props.maxTagCount ? "".concat(prefix, "-tag-group-max") : ''];
    });
    //关闭事件
    ...
    return function () {
      ...
      return createVNode("div", {
        "class": classes.value
      }, [props.tagList.slice(0, props.maxTagCount || props.tagList.length).map(function (tagItem, index) {
        return createVNode(Tag, mergeProps(tagItem, {
      ...
      }), props.tagList.length > (props.maxTagCount || props.tagList.length) && createVNode(Popover, mergeProps(props.popoverProps, {
        ...
        }, [props.tagList.slice(props.maxTagCount || props.tagList.length).map(function (tagItem, index) {
          return createVNode(Tag, mergeProps(tagItem, {
            "key": tagItem.tagKey || index,
            "size": tagItem.size || props.size,
            "avatarShape": tagItem.avatarShape || props.avatarShape,
        ...
        }, _isSlot(_slot = "+".concat(props.tagList.length - (props.maxTagCount || props.tagList.length))) ? _slot : {
          default: () => [_slot]
        })]
      })]);
    };
...
var Select = defineComponent({
  setup: function (props, ctx) {
    ...
    onMounted(function () {
      var _a;
      var triggerRect = (_a = triggerRef.value) === null || _a === void 0 ? void 0 : _a.getBoundingClientRect();
    ...
    var wrapperClass = computed(function () {
      var _a;
      return ["".concat(prefix, "-select"), (_a = {}, _a["".concat(prefix, "-select-disabled")] = props.disabled, _a["".concat(prefix, "-select-multiple")] = props.multiple, _a["".concat(prefix, "-select-open")] = state.visible, _a["".concat(prefix, "-select-focus")] = state.visible, _a)];
    });
    ...
    var renderPopoverContent1 = function () {
      ...
      if (optionList === null || optionList === void 0 ? void 0 : optionList.length) {
        children = optionList.map(function (child, index) {
          return h(SelectOption, __assign(__assign({}, child), {
        ...
        if (items === null || items === void 0 ? void 0 : items.length) {
          ...
          var _loop_1 = function (child) {
            var type = child.type;
            if (isObject(child.type) && [SelectOptionGroup.name, SelectOption.name].includes(type.name)) {
              if ([SelectOptionGroup.name].includes(type.name)) {
                // hander group
                var optionChilds = child.children.default() || [];
                template.push(h(child, {
                  label: (_c = child.props) === null || _c === void 0 ? void 0 : _c.label
                }));
                var _loop_2 = function (optionChild) {
                  var currentIndex = childIndex;
                  var label = ((_d = optionChild.props) === null || _d === void 0 ? void 0 : _d.label) || ((_g = (_f = (_e = child.children) === null || _e === void 0 ? void 0 : _e.default()) === null || _f === void 0 ? void 0 : _f[0]) === null || _g === void 0 ? void 0 : _g.children);
                  var optionParams = __assign(__assign({}, optionChild.props), {
                    label: label
                  });
                  template.push(h(optionChild, __assign(__assign({}, optionChild.props), {
                    onClick: function () {
                ...
                var label_1 = ((_h = child.props) === null || _h === void 0 ? void 0 : _h.label) || ((_l = (_k = (_j = child.children) === null || _j === void 0 ? void 0 : _j.default()) === null || _k === void 0 ? void 0 : _k[0]) === null || _l === void 0 ? void 0 : _l.children);
                var optionParams_1 = __assign(__assign({}, child.props), {
                  label: label_1
                });
                template.push(h(child, __assign(__assign({}, child.props), {
                  onClick: function () {
      ...
      if ((!children || isArray(children) && children.length === 0) && hasPropsOrSlots('emptyContent', vm)) {
    ...
    var multipleTagTemplate = function () {
      if (isArray(state.selfValue)) {
        ...
        var targetList = isShowMaxTagCount ? state.selfValue.slice(0, props.maxTagCount) : state.selfValue;
        ...
        if (isShowMaxTagCount) {
          ...
          template.push(createVNode(Popover, {
            ...
            "trigger": "hover",
            "showArrow": true,
            "content": createVNode("div", null, [resetList.map(function (item) {
    ...
    return function () {
      ...
      return createVNode(Popover, {
        ...
        }, [isEmpty(state.selfValue) ? props.multiple ? multipleTagTemplate() : createVNode("span", {
          "class": prefix + '-select-selection-text'
        }, [state.selfValue]) : createVNode("div", {
          "class": [prefix + '-select-selection-text', prefix + '-select-selection-placeholder']
        }, [hasPropsOrSlots('placeholder', vm) ? renderElementForPropsOrSlot('placeholder', vm) : '请选择'])])]), createVNode("div", {
...
var HotKeys = defineComponent({
  setup: function (props, ctx) {
    ...
    var contentWrapper = computed(function () {
      return ["".concat(prefix, "-hotKeys-content"), isBoolean(props.background) && props.background ? "".concat(prefix, "-hotKeys-content-background") : ''];
    });
    ...
    var _isValidHotKeys = function (hotKeys) {
      ...
      hotKeys.forEach(function (key) {
        key = key.toLowerCase();
        if (!allKeys.some(function (value) {
          return value === key;
        })) {
    ...
    var handleKeyDown = function (e) {
      ...
      var keysPressed = hotKeys === null || hotKeys === void 0 ? void 0 : hotKeys.map(function (key) {
        key = key.toLowerCase();
        if (key === Keys.Meta) {
          allModifier[0] = true;
          return e.metaKey;
      ...
      if (!allModifier.every(function (value, index) {
    ...
    return function () {
      var _a;
      if (props.render) {
        return createVNode("div", mergeProps(ctx.attrs, {
          "class": wrapper.value,
          "onClick": handleClick
      ...
      return createVNode("div", mergeProps(ctx.attrs, {
        ...
        return createVNode("span", {
          "key": index
        }, [isShowSplit(index) && createVNode("span", {
...
var dragMove = defineComponent({
  setup: function (props, ctx) {
    ...
    var triggerDragging = function (isDragging) {
      if (isDragging === undefined) state.isDragging = !state.isDragging;else state.isDragging = isDragging;
    };
    var handleDragMove = function (e) {
      ...
      if (isAllowMove) {
        if (!allowInputDrag && (e.target instanceof HTMLInputElement || e.target instanceof HTMLTextAreaElement)) {
          return;
        }
        if (dragMoveRef.value) {
    ...
    useEventListener(document.body, 'touchmove', function (e) {
      handleDragMove(e);
    }, {
      passive: false
    });
    ...
    function handleMoveStart(e) {
      ...
      if (e instanceof MouseEvent) ctx.emit('mouseDown', e);else {
        if (e.touches.length > 0) {
          var touch = e.touches[0];
          if (dragMoveRef.value) {
            var element = dragMoveRef.value;
    ...
    return function () {
      var _a, _b, _c;
      var component = (_b = (_a = ctx.slots).default) === null || _b === void 0 ? void 0 : _b.call(_a);
      if (component && component.length > 0) {
        var firstChild = component[0];
        var style = __assign({}, (_c = firstChild.props) === null || _c === void 0 ? void 0 : _c.style);
        if (!state.handlerEl) {
          style.cursor = 'move';
        }
        return h(firstChild, {
...
var Space = defineComponent({
  setup: function (props, ctx) {
    var wrapperNames = computed(function () {
      var _a;
      var classNames = [prefix + '-space', prefix + '-space-align-' + props.align, props.vertical ? [prefix + '-space-vertical'] : [prefix + '-space-horizontal'], (_a = {}, _a[prefix + '-space-wrap'] = props.wrap, _a)];
      if (isString(props.spacing)) {
        classNames.push(prefix + '-space-' + props.spacing + '-horizontal', prefix + '-space-' + props.spacing + '-vertical');
      }
      return classNames;
    });
    var wrapperStyle = computed(function () {
      ...
      if (isNumber(props.spacing)) {
        if (props.vertical) style.columnGap = props.spacing + 'px';else style.rowGap = props.spacing + 'px';
      }
...
var Spin = defineComponent({
  setup: function (props, ctx) {
    ...
    return function () {
      ...
      return createVNode("div", mergeProps(ctx.attrs, {
        "class": spinNames
      }), [showSpin.value && createVNode("div", {
        "class": wrapperNames.value
      }, [props.indicator ? renderElementForPropsOrSlot('indicator', vm) : createVNode(Fragment, null, [createVNode(SpinIcon, null, null), props.tip ? createVNode("div", {
        "class": prefix + '-spin-tip'
      }, [renderElementForPropsOrSlot('tip', vm)]) : null])]), content && createVNode("div", {
...
var Layout = defineComponent({
  setup: function (props, ctx) {
    ...
    var classNames = computed(function () {
      var _a;
      return [prefix + '-layout', (_a = {}, _a[prefix + '-layout-has-sider'] = hasSider.value, _a)];
    });
...
var Header = defineComponent({
  setup: function (props, ctx) {
    return function () {
      var _a, _b;
      return createVNode("header", mergeProps({
...
var Content = defineComponent({
  setup: function (props, ctx) {
    return function () {
      var _a, _b;
      return createVNode("main", mergeProps({
...
var Footer = defineComponent({
  setup: function (props, ctx) {
    return function () {
      var _a, _b;
      return createVNode("footer", mergeProps({
...
var Sider = defineComponent({
  setup: function (props, ctx) {
    ...
    if (isFunction(parentData === null || parentData === void 0 ? void 0 : parentData.emitSider)) parentData.emitSider();
...
var Switch = defineComponent({
  setup: function (props, ctx) {
    ...
    var wrapperClassNames = computed(function () {
      var _a;
      return ["".concat(prefix, "-switch"), (_a = {}, _a["".concat(prefix, "-switch-checked")] = state.checked, _a["".concat(prefix, "-switch-disabled")] = props.disabled, _a["".concat(prefix, "-switch-loading")] = props.loading, _a["".concat(prefix, "-switch-").concat(props.size)] = props.size, _a)];
    });
    ...
    if (props.modelValue !== undefined && props.checked !== undefined) {
      consolaWapper.warn('Switch components modelValue and checked cannot be passed in simultaneously.');
    }
    var vm = getCurrentInstance();
    ...
    var renderCheckedKnob = function () {
      ...
      if (hasPropsOrSlots('checkedKnob', vm) || hasPropsOrSlots('uncheckedKnob', vm)) {
        var warpper = function (vnode) {
          if (vnode) return createVNode("div", {
            "class": "".concat(prefix, "-switch-knob")
          }, [vnode]);
          return template;
        };
        return state.checked ? warpper(renderElementForPropsOrSlot('checkedKnob', vm)) : warpper(renderElementForPropsOrSlot('uncheckedKnob', vm));
      }
      return template;
    };
    return function () {
      ...
      }, [props.loading ? createVNode(Spin, {
        "size": getSpinSize.value,
        "class": "".concat(prefix, "-switch-loading-spin")
      }, null) : renderCheckedKnob(), props.size !== 'small' && renderTextSlot(), createVNode("input", {
...
var Toast$1 = defineComponent({
  setup: function (props, ctx) {
    ...
    var classNames = computed(function () {
      var _a;
      return [prefix + '-toast', prefix + '-toast-' + props.type, (_a = {}, _a[prefix + '-toast-light'] = props.theme === 'light', _a)];
    });
    var vm = getCurrentInstance();
    var renderIcon = function () {
      ...
      return props.type === toastTypeMap.success ? createVNode(IconTickCircle$1, {
        "class": classNames,
        "size": size
      }, null) : props.type === toastTypeMap.warning ? createVNode(IconAlertTriangle$1, {
        "class": classNames,
        "size": size
      }, null) : props.type === toastTypeMap.error ? createVNode(IconAlertCircle$1, {
        "class": classNames,
        "size": size
      }, null) : createVNode(IconInfoCircle$1, {
        "class": classNames,
        "size": size
      }, null);
    };
    var renderContent = function () {
      ...
      if (isNumber(maxWidth)) maxWidth = maxWidth + 'px';else {
    ...
    return function () {
      return createVNode(CSSAnimation, {
        ...
        "startClassName": state.animationState === 'enter' ? "".concat(prefix, "-toast-animation-show") : "".concat(prefix, "-toast-animation-hide"),
        "onAnimationStart": handleAnimationStart,
        "onAnimationEnd": handleAnimationEnd
      }, {
        default: function (_a) {
          ...
          }, [renderIcon(), renderContent(), props.showClose && createVNode("div", {
  ...
  setup: function (props, ctx) {
    ...
    ctx.expose({
      ...
      remove: function (toastId) {
        ...
        if (data) {
          (_b = (_a = state.absorptionCloseCallbacks)[data.id]) === null || _b === void 0 ? void 0 : _b.call(_a);
        }
      },
      destroyAll: function () {
        var _a, _b;
        for (var item in state.absorptionCloseCallbacks) {
          (_b = (_a = state.absorptionCloseCallbacks)[item]) === null || _b === void 0 ? void 0 : _b.call(_a);
        }
      },
    ...
    return function () {
      ...
      return createVNode("div", {
        "onMouseenter": handleMouseenter,
        "onMouseleave": handleMouseleave,
        "class": [prefix + '-toast-wrapper', (_a = {}, _a[prefix + '-toast-wrapper-hover'] = state.isHover && state.stack, _a)],
        "id": wrapperId,
        "style": __assign({
          zIndex: state.zIndex
        }, state.style)
...
var ToastImplement = /** @class */function () {
  ...
  ToastImplement.prototype.getWarpper = function (options) {
    ...
    if (options) {
      ...
      this.container = (getPopupContainer === null || getPopupContainer === void 0 ? void 0 : getPopupContainer()) || defaultConfig.getPopupContainer();
    }
  ...
  ToastImplement.prototype.destroyAll = function () {
    ...
    this.ids = [];
    this.clears = (this.clears.map(function (c) {
      c();
    }), []);
  };
...
var components = [Button, ButtonGroup, SyncButton, Watermark, Input, Icon, IconJsx, Row, Col, Popover, Tooltip, Select, SelectOption, SelectOptionGroup, HotKeysWithKeys, Avatar, AvatarGroup, Tag, TagGroup, dragMove, Space, Spin, Layout, Header, Content, Footer, Sider, Switch, Toast, ToastFactory];
...
export { Avatar, AvatarGroup, Button, ButtonGroup, Col, Content, dragMove as DragMove, Footer, Header, HotKeysWithKeys as HotKeys, Icon, IconJsx, Input, Layout, Popover, Row, Select, SelectOption, SelectOptionGroup, Sider, Space, Spin, Switch, SyncButton, Tag, TagGroup, Toast, ToastFactory, Tooltip, Watermark, install, registerGlobalApiToDocs };
