...
const IconJsonViewer = defineComponent((props: SVGAttributes) => {
  return () => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      <path
        d="M2 5a3 3 0 0 1 3-3h12a3 3 0 0 1 3 3v10a3 3 0 0 1-3 3H5a3 3 0 0 1-3-3V5Z"
        fill="#DDE3E8"
      ></path>
      <path
        fill-rule="evenodd"
...
export default warpperIcon(IconJsonViewer, 'IconJsonViewer')
