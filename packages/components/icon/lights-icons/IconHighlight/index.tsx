...
const IconHighlight = defineComponent((props: SVGAttributes) => {
  return () => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
      ...
      {...props}
    >
      <rect x="3" y="8" width="18" height="8" rx="1" fill="#FAC800"></rect>
      <path
...
export default warpperIcon(IconHighlight, 'IconHighlight')
