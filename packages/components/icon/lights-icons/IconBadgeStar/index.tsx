...
const IconBadgeStar = defineComponent((props: SVGAttributes) => {
  return () => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
      ...
      {...props}
    >
      <path d="M23 12a11 11 0 1 1-22 0 11 11 0 0 1 22 0Z" fill="#FF7D95"></path>
      <path
...
export default warpperIcon(IconBadgeStar, 'IconBadgeStar')
