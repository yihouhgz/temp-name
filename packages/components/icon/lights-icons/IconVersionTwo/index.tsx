...
const IconVersionTwo = defineComponent((props: SVGAttributes) => {
  return () => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
      ...
      {...props}
    >
      <rect x="2" y="2" width="20" height="20" rx="3" fill="#4CC3FA"></rect>
      <path
...
export default warpperIcon(IconVersionTwo, 'IconVersionTwo')
