...
const IconFeishuLogo = defineComponent((props: SVGAttributes) => {
  return () => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      <path
        ...
        fill="currentColor"
      ></path>
      <path d="m20.57 14.2.01-.02.04-.07-.05.08Z" fill="currentColor"></path>
      <path
        ...
        fill="currentColor"
      ></path>
      <path d="M20.8 13.78v-.02l.01-.01s0 .02-.02.03Z" fill="currentColor"></path>
      <path
...
export default warpperIcon(IconFeishuLogo, 'IconFeishuLogo')
