...
const IconMicrophoneOff = defineComponent((props: SVGAttributes) => {
  return () => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      <path
        ...
        fill="currentColor"
      ></path>
      <path d="m12 16 4.5-4.5A4.5 4.5 0 0 1 12 16Z" fill="currentColor"></path>
      <path
...
export default warpperIcon(IconMicrophoneOff, 'IconMicrophoneOff')
