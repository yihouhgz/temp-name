...
const IconAIStrokedLevel3 = defineComponent((props: SVGAttributes) => {
  return () => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      <path
        ...
        fill="url(#semi-ai-stroked-level-3-a95P5ZT)"
      ></path>
      <defs>
        <linearGradient
          id="semi-ai-stroked-level-3-a95P5ZT"
          x1="23.0001"
          y1="22.0012"
          x2="-0.488689"
          y2="18.6982"
...
export default warpperIcon(IconAIStrokedLevel3, 'IconAIStrokedLevel3')
