...
const IconTicketCodeExchangeStroked = defineComponent((props: SVGAttributes) => {
  return () => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export default warpperIcon(IconTicketCodeExchangeStroked, 'IconTicketCodeExchangeStroked')
