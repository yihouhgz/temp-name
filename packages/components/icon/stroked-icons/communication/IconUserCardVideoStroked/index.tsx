...
const IconUserCardVideoStroked = defineComponent((props: SVGAttributes) => {
  return () => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
      ...
      {...props}
    >
      <path d="M8 11H5V8h3v3Z" fill="currentColor"></path>
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
...
export default warpperIcon(IconUserCardVideoStroked, 'IconUserCardVideoStroked')
