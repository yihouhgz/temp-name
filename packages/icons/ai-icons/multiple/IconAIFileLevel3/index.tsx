...
const IconAIFileLevel3 = defineComponent((props: SVGAttributes) => {
  return () => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      <path
        ...
        fill="url(#semi-ai-file-level-3-bDSlXHC)"
      ></path>
      <defs>
        <linearGradient
          id="semi-ai-file-level-3-bDSlXHC"
          x1="21.9999"
          y1="23"
          x2="0.643144"
          y2="20.4063"
...
export default warpperIcon(IconAIFileLevel3, 'IconAIFileLevel3')
