...
const IconChart = defineComponent((props: SVGAttributes) => {
  return () => (
    <svg
    ...
    >
      <path
        ...
        fill="#4CC3FA"
        style="fill: color(display-p3 0.298 0.7647 0.9804); fill-opacity: 1;"
      ></path>
      <path
        ...
        fill="#6A6F7F"
        style="fill: color(display-p3 0.4157 0.4353 0.498); fill-opacity: 1;"
      ></path>
      <path
        ...
        fill="#DDE3E8"
        style="fill: color(display-p3 0.8667 0.8902 0.9098); fill-opacity: 1;"
      ></path>
      <path
        ...
        fill="#AAB2BF"
        style="fill: color(display-p3 0.6667 0.698 0.749); fill-opacity: 1;"
      ></path>
    </svg>
  )
})
export default warpperIcon(IconChart, 'IconChart')
