...
const IconAutocomplete = defineComponent((props: SVGAttributes) => {
  return () => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      <path
        ...
        fill="#AAB2BF"
      ></path>
      <rect x="19" y="6" width="2" height="12" rx="1" fill="#324350"></rect>
    </svg>
  )
})
export default warpperIcon(IconAutocomplete, 'IconAutocomplete')
