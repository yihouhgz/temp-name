...
const IconDatePicker = defineComponent((props: SVGAttributes) => {
  return () => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      <g clip-path="url(#clip0_1_3038)">
        ...
        <path
          ...
          fill="white"
        ></path>
        <path d="M15 24V14l7 7h-4.32L15 24Z" fill="#324350"></path>
      </g>
      <defs>
...
export default warpperIcon(IconDatePicker, 'IconDatePicker')
