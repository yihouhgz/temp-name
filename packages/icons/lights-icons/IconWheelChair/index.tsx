...
const IconWheelChair = defineComponent((props: SVGAttributes) => {
  return () => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      <path
        ...
        fill="#4CC3FA"
      ></path>
      <path d="M13 3a2 2 0 1 1-4 0 2 2 0 0 1 4 0Z" fill="#6A6F7F"></path>
      <path
...
export default warpperIcon(IconWheelChair, 'IconWheelChair')
