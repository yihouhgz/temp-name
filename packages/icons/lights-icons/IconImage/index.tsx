...
const IconImage = defineComponent((props: SVGAttributes) => {
  return () => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
      ...
      {...props}
    >
      <path d="M4 4h7v7H4V4Z" fill="#FBCD2C"></path>
      <path d="M3 11h17v9H3v-9Z" fill="#3BCE4A"></path>
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
...
export default warpperIcon(IconImage, 'IconImage')
