...
const IconInputNumber = defineComponent((props: SVGAttributes) => {
  return () => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      <path d="M15 4h5a3 3 0 0 1 3 3v10a3 3 0 0 1-3 3h-5V4Z" fill="#4CC3FA"></path>
      <path d="m19 7.5 2 3h-4l2-3Z" fill="white"></path>
      <path d="m19 16.5-2-3h4l-2 3Z" fill="white"></path>
      <path
...
export default warpperIcon(IconInputNumber, 'IconInputNumber')
