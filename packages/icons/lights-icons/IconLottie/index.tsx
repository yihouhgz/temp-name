...
const IconLottie = defineComponent((props: SVGAttributes) => {
  return () => (
    <svg
      viewBox="0 0 22 18"
      fill="none"
      ...
      {...props}
    >
      <rect width="22" height="18" rx="2" fill="#F9FCFF"></rect>
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
      ...
      <path
        ...
        fill="#AEB2BE"
      ></path>
      <path d="M14.5 5c-2 0-4 .36-4 4 0 3.5-1.5 5-4 5" stroke="#AEB2BE"></path>
      <rect x="14" y="4" width="2" height="2" fill="#F77C93"></rect>
      <rect x="6" y="13" width="2" height="2" fill="#F8CE27"></rect>
      <path
...
export default warpperIcon(IconLottie, 'IconLottie')
