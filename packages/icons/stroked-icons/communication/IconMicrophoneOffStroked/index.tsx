...
const IconMicrophoneOffStroked = defineComponent((props: SVGAttributes) => {
  return () => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
      ...
      {...props}
    >
      <path d="M16 21a1 1 0 0 1 0 2H8a1 1 0 1 1 0-2h8Z" fill="currentColor"></path>
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
...
export default warpperIcon(IconMicrophoneOffStroked, 'IconMicrophoneOffStroked')
