...
const IconCartStroked = defineComponent((props: SVGAttributes) => {
  return () => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
      ...
      {...props}
    >
      <path d="M9.65 18a2 2 0 1 1 0 4 2 2 0 0 1 0-4Z" fill="currentColor"></path>
      <path d="M18.65 18a2 2 0 1 1 0 4 2 2 0 0 1 0-4Z" fill="currentColor"></path>
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
...
export default warpperIcon(IconCartStroked, 'IconCartStroked')
