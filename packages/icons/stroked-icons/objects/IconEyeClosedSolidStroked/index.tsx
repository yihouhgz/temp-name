...
const IconEyeClosedSolidStroked = defineComponent((props: SVGAttributes) => {
  return () => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      <path
        ...
        fill="currentColor"
      ></path>
      <path d="m15.98 11.23.02.36a4 4 0 0 1-4.36 3.98l4.34-4.34Z" fill="currentColor"></path>
    </svg>
  )
})
export default warpperIcon(IconEyeClosedSolidStroked, 'IconEyeClosedSolidStroked')
