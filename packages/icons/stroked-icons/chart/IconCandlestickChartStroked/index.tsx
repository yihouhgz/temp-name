...
const IconCandlestickChartStroked = defineComponent((props: SVGAttributes) => {
  return () => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export default warpperIcon(IconCandlestickChartStroked, 'IconCandlestickChartStroked')
