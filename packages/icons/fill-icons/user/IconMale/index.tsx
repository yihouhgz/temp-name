...
const IconMale = defineComponent((props: SVGAttributes) => {
  return () => (
    <span role="img" aria-label="male" class="semi-icon semi-icon-default semi-icon-male">
      <svg
        viewBox="0 0 24 24"
        fill="none"
...
export default warpperIcon(IconMale, 'IconMale')
