...
const IconRegExp = defineComponent((props: SVGAttributes) => {
  return () => (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      <path
        ...
        fill="currentColor"
      ></path>
      <circle cx="6.5" cy="17.5" r="4.5" fill="currentColor"></circle>
    </svg>
  )
})
export default warpperIcon(IconRegExp, 'IconRegExp')
